    ...
    <main>
      {workExperience.map((role) => (
        <div key={role.title} className="flex flex-col bg-gray-800 p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow border border-gray-700 hover:border-emerald-500">
          ...
          <dd className="mt-2 text-sm leading-6 text-gray-400 italic border-l-2 border-emerald-500 pl-3">{role.company_description}</dd>
          ...
          {role.tools_used && (
            <dd className="mt-2">
              ...
              <div className="flex flex-wrap gap-2">
                {role.tools_used.split(", ").map((tool, index) => (
